...
public class AmazonStepdefinitions {
    ...
    @And("sonuclari {string} icerdigini test eder")
    public void sonuclariIcerdiginiTestEder(String arananKelime) {
    ...
    public void urunIsmininIcerdiginiTestEder(String arg0) {
    }
}
